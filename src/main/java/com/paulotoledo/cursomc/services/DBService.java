...
import com.paulotoledo.cursomc.domain.Categoria;
import com.paulotoledo.cursomc.domain.Cidade;
...
import com.paulotoledo.cursomc.domain.enums.TipoCliente;
import com.paulotoledo.cursomc.repositories.CategoriaRepository;
import com.paulotoledo.cursomc.repositories.CidadeRepository;
...
public class DBService {
	...
	public void instantiateDatabase() throws ParseException {
		...
		Cliente cli1 = new Cliente(null, "Maria Silva", "ptoledo.bsices@gmail.com", "36378912377", TipoCliente.PESSOAFISICA, pe.encode("123"));
		cli1.getTelefones().addAll(Arrays.asList("27363323", "93838393"));
		
		Cliente cli2 = new Cliente(null, "Ana Costa", "ptoled@gmail.com", "31628382740", TipoCliente.PESSOAFISICA, pe.encode("123"));
		cli2.getTelefones().addAll(Arrays.asList("93883321", "84252625"));
